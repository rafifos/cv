...
\patchcmd{\ps@customFooterStyle}{\thepage}{
    \color{gray}\textit{\small Rafael Julio Lemos Silva - Page \thepage{} of \pageref*{LastPage}}
...
\begin{document}
    ...
    \section{Projects}
        ...
        \textit{\href{https://github.com/rafifos/website}{github.com/rafifos/website}}}
        ...
        \begin{onecolentry}
            \begin{highlights}
                \item Developed a personal website using Next.js, React, TypeScript, and Tailwind CSS
                \item Deployed to Vercel with a custom Domain
            \end{highlights}
        \end{onecolentry}
        ...
        \textit{\href{https://github.com/rafifos/dotfiles}{github.com/rafifos/dotfiles}}}
            \textbf{Dotfiles}
        \end{twocolentry}
        ...
        \textit{\href{https://github.com/rafifos/IosevkaCustom}{github.com/rafifos/IosevkaCustom}}}
